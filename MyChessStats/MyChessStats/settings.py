"""
Django settings for MyChessStats project.
...
SECRET_KEY = 'django-insecure-dbi3**1b)fqbowkxn5uz(ggal@v5^)*@9=-kyjgn#3jm_6-kjp'
...
INSTALLED_APPS = [
    'WebChessStats.apps.WebChessStatsConfig',
...
CORS_ALLOW_CREDENTIALS = True  # Allow cookies/CSRF token to be sent
...
ROOT_URLCONF = 'MyChessStats.urls'
...
WSGI_APPLICATION = 'MyChessStats.wsgi.application'
